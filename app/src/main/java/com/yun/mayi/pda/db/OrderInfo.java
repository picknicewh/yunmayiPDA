 ...
 * 子订单
 */
@DatabaseTable(tableName = "order_info")
public class OrderInfo {
     ...
     * 买家购买数量
     */
    public static final String SKUNUM = "skuNum";
    /**
     * 异常数量
     */
    ...
    @DatabaseField(columnName = SKUNUM, dataType = DataType.INTEGER)
    private int skuNum;
    ...
    @DatabaseField(columnName = ISCHECKED, dataType = DataType.INTEGER)
