 ...
 * 主要接口：
 */
public class WaitPackPresenter extends BasePresenter<WaitPackContract.View> implements WaitPackContract.Presenter {
    @Inject
    public WaitPackPresenter() {
    }
    ...
    public void getPackList() {
        ...
        parameter.setParam("pickerId", mView.getPickerId());
