 ...
 * 主要接口：
 */
public class WaitPackedPresenter extends BasePresenter<WaitPackedContract.View> implements WaitPackedContract.Presenter {

    @Inject
    public WaitPackedPresenter() {
